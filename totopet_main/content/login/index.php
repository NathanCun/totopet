<?php
	if(isset($_POST["login"])){
		...
		$injeksi_username = mysqli_real_escape_string($conn, $email);
		...
		// else{
			$query  = "SELECT * FROM user WHERE email='$email' AND password='$password' AND verifikasi='Y'";
			...
			if ($ketemu > 0){
				...
				if($r["role"] == "admin"){
					...
					header('location:../../../dashboard/dashboard/content/user/index.php');
				}
				else{
				...
				/*
				if(isset($_SESSION[email] AND isset() AND ())){
